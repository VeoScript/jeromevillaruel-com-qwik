...
export const Facebook = component$(() => {
  return (
    <svg
      class="w-5 h-5 fill-current text-white transition ease-in-out duration-200 transform hover:scale-90 hover:text-accent-3"
...
export const Magaaazine = component$(() => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="256.000000pt"
